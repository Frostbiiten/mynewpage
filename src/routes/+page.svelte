...
>
    <div class="relative h-250 w-7xl">
        <div
            ...
            style="transform: translate3d({smoothX * -30 - 400}px, {smoothY *
                -30 +
                180}px, 0);"
        ></div>
        ...
        <div
            ...
            style="transform: translate3d({smoothX * -100 - 500}px, {smoothY *
                -100 +
                480}px, 0);"
        ></div>
        ...
        <div
            ...
            style="transform: translate3d({smoothX * -35 - 800}px, {smoothY *
                -35 +
                280}px, 0);"
        ></div>
        ...
        <div
            ...
            style="transform: translate3d({smoothX * -30 - 700}px, {smoothY *
                -30 +
                580}px, 0);"
        ></div>
        ...
        <div
            ...
            style="transform: translate3d({smoothX * -9 - 580}px, {smoothY *
                -9 +
                280}px, 0);"
        ></div>
        ...
        <div
            ...
            style="transform: translate3d({smoothX * -6 - 400}px, {smoothY *
                -6 +
                280}px, 0);"
        ></div>
        ...
        <div
            ...
            style="transform: translate3d({smoothX * -100 + 400}px, {smoothY *
                -100 +
                280}px, 0);"
        ></div>
        ...
        <div
            ...
            style="transform: translate3d({smoothX * -35 + 400}px, {smoothY *
                -35 +
                480}px, 0);"
        ></div>
    ...
    >
        ...
        >
            ...
            <div
                ...
                style="transform: translate3d({mouseState.smoothX * -2.4}%, {mouseState.smoothY * -13 + 30}px, 0) scale({0.3 * (1 - mouseState.dist01 * 0.02)}); filter: blur({easeInOutCubic(Math.max(0, mouseState.dist01 - 0.6) * 2) * 0}px)"
            >
                <div
                    class={cx(
                ...
                <div class="absolute flex items-center z-[430] top-0 right-0 w-20 h-80 -translate-x-1/2 translate-y-[-150%] pointer-events-none" style="transform: translate({smoothX * -30 - 1000}px, {smoothY * -30}px)">
                    <div
                        class={cx(
                            ...
                            !characterhover &&
                                "translate-x-60 md:translate-x-55",
                        )}
                    >
                        <div
                            class={cx(
                        ...
                        >
                            ...
                            <div
                                ...
                                class={cx(
                                    ...
                                    characterhover &&
                                        "opacity-100 ease-out delay-300 ",
                                    !characterhover &&
                                        "opacity-0 ease-in delay-0",
                                )}
                            >
                                Welcome to my world of interesting projects!
                                Please feel free to look around.

                                <br />
                                <br />

                                This website is in a rather early state, so
                                please report any bugs you come across to @edemh
                                on discord. Please note I also go by
                                ...
                                <strong>C++</strong> right now. It'll be added to
                                the projects page soon!
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="absolute top-0 left-0 w-full h-full">
                <div class="relative z-0 w-full h-full">
                    <div
                        class="top-0 left-0 p-7 w-full h-full md:absolute md:p-12"
                    >
                        <div
                            class={cx(
                        ...
                        >
                            ...
                            <h2 class="z-40 px-1 text-lg md:text-2xl transition-all tracking-[0.2em] md:tracking-[0.3em] text-stone-300 md:text-slate-500">
                                Hoggar
                            </h2>
                            ...
                            >
                                ...
                                <p
                                    class="text-[0.9rem] leading-loose text-stone-100 p-4 py-3"
                                >
                                    <strong class="inline"></strong>
                                    Seeking Fall 2025 Software Dev roles. Find contacts
                            ...
                            >
                                <p class="flex flex-row flex-wrap items-center">
                                    ...
                                    Seeking Summer 2026 Software Development
                                    roles. Check out my contacts below for any
                                    inquiries.
                                </p>
                            </div>
                        </div>
        ...
        >
            ...
            >
                {#if infoText}
                    {infoText}
                {:else}
                    Welcome to <span class="font-semibold">my world!</span> Feel
